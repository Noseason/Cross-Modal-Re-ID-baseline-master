...
parser.add_argument('--dataset', default='sysu', help='dataset name: regdb or sysu or tvpr2]')
...
if dataset == 'sysu':
    ...
    data_path = '/data3/QK/remote/AGW/datasets/RegDB/'
    log_path = args.log_path + 'regdb_log/'
    test_mode = [2, 1]  # visible to thermal
elif dataset == 'tvpr2':
    data_path = '/data3/QK/remote/AGW/datasets/RegDB/'#####这边要改，路径不记得了
    log_path = args.log_path + 'tvpr_log/'
    test_mode = [2, 1]  # visible to thermal
...
##下面这个是深度的
normalize2 = transforms.Normalize(mean=[0.456], std=[0.225])###这边的数值可能要改
